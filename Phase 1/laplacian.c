...
int main() {
  ...
  for(j = 1 ; j < height - 1 ; ++j) {
    ...
    g =     data[((j - 1) * width + i - 1) * 3 + c] * 0 +     data[((j - 1) * width + i + 1) * 3 + c] * 0
      +     data[( j      * width + i - 1) * 3 + c] * -1 +     data[( j      * width + i + 1) * 3 + c] * -1
	  +     data[((j + 1) * width + i - 1) * 3 + c] * 0 +     data[((j + 1) * width + i + 1) * 3 + c] * 0
      +     data[(( j - 1) * width + i) * 3 + c] * -1     +     data[( j      * width + i) * 3 + c] * 4
      +     data[(( j + 1) * width + i) * 3 + c] * -1;
